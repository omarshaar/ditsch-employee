...
// api
import { AddLieferschein, uploadImage } from "../../services/mainService";

const Lieferschein = () => {
    const [ date, setDate ] = useState(null);
    const [item, setItem] = useState('');
    const [unit, setUnit] = useState('Karton');
    ...
    const [ alertMessage, setAlertMessage ] = useState('Erfolgreich geupdated.');
    ...
    function handleUploadImage() {
        let target = document.getElementById("lieferschein");
        ...
        fd.append('date', formatDate(date));
        fd.append("type", "lieferschein");
    ...
    const addArticleHandler = () => {
        ...
        if (articleIsset.length > 0) {
            ...
            const article_Object = {
                ...
                unit: unit,
                amount: menge * (articel_Detailes.piecesInBag * articel_Detailes.bagInCarton),
            }
    ...
    return (
        <div className="w-full min-h-screen ">
            ...
            <input className="h-full hidden" accept="image/*" id="lieferschein" type="file" capture="environment" disabled={loading} />

            <div className="w-full p-5 page m-auto">

                <div className="w-full mb-4 flex justify-between items-center">
                    <p className="text-main text-2xl font-bold">Lieferschein</p>
                    <label htmlFor="lieferschein" className="w-8 h-8 bg-main rounded-md flex justify-center items-center">
                        <svg width="20" height="20" viewBox="0 0 24 24" strokeWidth="2" stroke="#fff" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><circle cx="12" cy="13" r="3" /><path d="M5 7h2a2 2 0 0 0 2 -2a1 1 0 0 1 1 -1h2m9 7v7a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-9a2 2 0 0 1 2 -2" /><line x1="15" y1="6" x2="21" y2="6" /><line x1="18" y1="3" x2="18" y2="9" /></svg>
                    </label>
                </div>
