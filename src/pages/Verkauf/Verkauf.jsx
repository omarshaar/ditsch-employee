...
const Verkauf = () => {
    ...
    const [totalUmsatz, setTotalUmsatz] = useState(0);
    ...
    const applayHandle = () => {
        ...
        try{
            ...
            window.confirm('Sind Sie Sicher?') && postData('https://apiditsch.oderasid.com/', 
            {
                req: "AddVerkauf",
                articels: ArticlesList, 
                length: ArticlesList.length, 
                date: formatDate(date),
                totalUmsatz: totalUmsatz,
                notes: note,
        ...
        <div className="w-full min-h-screen ">
            ...
            <div className="w-full p-5 page m-auto">
                ...
                <div className="w-full mb-4">
                    <p className="text-main text-2xl font-bold">Verkauf</p>
                </div>
                ...
                <div className="flex flex-col justify-between mb-5">
                    <p className="text-main font-bold">Total Umsatz</p>
                    <TextField
                        type="number"
                        placeholder="0"
                        value={totalUmsatz}
                        onChange={(e)=> handelChange(e, setTotalUmsatz)}
                    />
                </div>

                <div className="flex flex-col justify-between mb-5">
                    <p className="text-main font-bold">Hinweiss</p>
                    <TextField
                        type="text"
                        placeholder=".."
                        value={note}
                        onChange={(e)=> handelChange(e, setNote)}
                    />
                </div>
